CREATE DATABASE Provinsi_Indonesia;

SHOW DATABASES;
USE Provinsi_Indonesia;

CREATE TABLE daftar_provinsi(id_prov INT,pulau VARCHAR(100), nama_provinsi VARCHAR (100), singkatan_iso VARCHAR (5), 
ibu_kota VARCHAR (100),tgl_resmi DATE,populasi INT,luas FLOAT(10,2),populasi_per_luas INT,apbd FLOAT(10,2),pdrb FLOAT(10,2),
pdrb_per_kapita FLOAT(5,2),ipm FLOAT(5,2));
